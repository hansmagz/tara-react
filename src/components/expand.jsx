  ...
  return (
    <Box className='expandBox'>
      <Grid container justifyContent={'space-between'}>
        ...
        <Grid item md={12} sm={12} xs={12} textAlign={'-webkit-center'} alignSelf={'center'}>
          <Reveal>
            <Typography variant={isSmScreen ? 'h2' : 'h1'} fontWeight={900} fontFamily={'Roboto'} color={'#DF9146'}>
              EXPANDING SOON
            </Typography>
            <Typography variant={isSmScreen ? 'h6' : 'h5'} fontWeight={300} fontFamily={'Roboto'} color={'#DF9146'}>
              TO CEBU, DAVAO, & GENSAN
            </Typography>
          </Reveal>
        </Grid>

        <Grid item md={12} sm={12} xs={12} mb={4} textAlign={'-webkit-center'} alignSelf={'end'}>
          <Reveal>
