  ...
  return (
    <>
      <Grid container
        ...
        spacing={4}
      >
        {/* <Grid item md={12} sm={12} xs={12} textAlign={'-webkit-center'}>
          <Reveal>
            <Stack>
        ...
        <Grid item md={12} mt={6}>
          <Box bgcolor={'white'} color={'#DF9146'} textAlign={'center'} borderRadius={'40px'} py={12} px={isSmScreen ? 3 : 6} className='why-card'>
            <Reveal>
              <span style={{ fontSize: '2rem', fontFamily: 'Coolvetica', border: '2px solid #DF9146', borderRadius: '10px', paddingInline: '40px', paddingBlock: '6px' }}>About Us</span>
        ...
        {/* <Grid item md={12} mt={6}>
          <Box bgcolor={'white'} borderRadius={'40px'} py={12} px={isSmScreen ? 3 : 6} className='why-card'>
            <Grid container spacing={6} color={'#DF9146'}>
              <Grid item md={6} textAlign={'center'}>
                <Reveal>
                  <span style={{ fontSize: '3rem', fontFamily: 'Coolvetica', border: '2px solid #DF9146', borderRadius: '10px', paddingInline: '40px', paddingBlock: '6px' }}>Mission</span>
              ...
              <Grid item md={6} textAlign={'center'}>
                <Reveal>
                  <span style={{ fontSize: '3rem', fontFamily: 'Coolvetica', border: '2px solid #DF9146', borderRadius: '10px', paddingInline: '40px', paddingBlock: '6px' }}>Vision</span>
