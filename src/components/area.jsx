        ...
        <Grid container item md={12} sm={12} xs={12}
          ...
          <Grid item>
            <Grid container item>
              <Grid item xs>
                <Reveal>
                  <Typography fontStyle={'italic'} fontWeight={'500'} fontSize={'2em'} sx={{ backgroundColor: '#DF9146' }} px={2}>PORTS</Typography>
                </Reveal>
              </Grid>
              <Grid item xs mt={4} textAlign={'-webkit-center'}>
                <Reveal>
              ...
              <Grid item xs textAlign={'-webkit-center'}>
                <Reveal>
          ...
          <Grid item order={{ xs: 1, md: 2 }}>
            <Grid container item>
              <Grid item xs={12} sm={12} md={12}>
                <Reveal>
                  <Typography fontStyle={'italic'} fontWeight={'500'} color={'#DF9146'} fontSize={'2em'} sx={{ backgroundColor: '#FFFFFF' }} px={2}>CAR RENTAL</Typography>
                </Reveal>
              </Grid>
              <Grid item xs={12} sm={12} md={12}>
                <Reveal>
